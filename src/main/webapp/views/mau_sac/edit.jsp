            ...
            <form method="POST" action="/mau-sac/update?id=${ms.id}">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="ma" value="${ ms.ma }" class="form-control"/>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Tên màu</label>
                        <input type="text" name="ten" value="${ ms.ten }" class="form-control"/>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                ...
                <div class="text-center">
                    ...
                    <a class="btn btn-primary" href="/mau-sac/index">Quay lại</a>
                </div>
            </form>
        </div>
    </div>
