...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <h3 class="text-center mb-4">Cật nhật khách hàng</h3>
            <form method="POST" action="/khach-hang/update?id=${kh.id}">
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label">Mã</label>
                        <input type="text" name="ma" value="${ kh.ma }" class="form-control"/>
                    </div>
                    <div class="col-md-6">
                        <label class="form-label">Tên màu</label>
                        <input type="text" name="ten" value="${ kh.ten }" class="form-control"/>
                    </div>
                </div>
                <div class="row mb-3">
                    <div class="col-md-6">
                        <label class="form-label">SDT</label>
                        <input type="text" name="sdt" value="${ kh.sdt }" class="form-control"/>
                    </div>
                    <div class="col-md-6">
